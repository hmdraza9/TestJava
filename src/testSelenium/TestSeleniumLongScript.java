...
public class TestSeleniumLongScript {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		String browser = pr.propReader("browser");
	...
	public static void longScript(WebDriver driver, ScreenshotTaker st) throws InterruptedException, AWTException {
...
class ThreadHelperOne implements Runnable {
	...
	public void run() {
		...
		try {
			TestSeleniumLongScript.longScript(driver, st);
